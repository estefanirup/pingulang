...
# Inicialização
1. Compilar o arquivo pinguLangCompiler.jjt usando a extensão JavaCC
2. Iniciar o arquivo Interface.java no pacote frame

# Nossa Backus-Naur deve ser alterada
```Backus-Naur Form
